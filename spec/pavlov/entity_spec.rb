...
describe Pavlov::Entity do
  ...
  describe '.new' do
    ...
    it 'must return not nil' do
      ...
      expect(test_object).to_not eq nil
    end

    it 'must return the correct class' do
      test_object = test_class.new

      expect(test_object.class).to eq test_class
    end
    ...
    it 'must set the attribute when given a block' do
      ...
      expect(test_object.name).to eq default_name
    end
    ...
    it 'must set the attribut to the value of a local method' do
      ...
      expect(test_object.name).to eq helper_method
    end
    ...
    it 'must be able to set two attributes when given a block' do
      ...
      expect(test_object.name).to eq default_name
      expect(test_object.test).to eq test_value
    end
  ...
  describe '.update' do
    ...
    it 'must partially update a entity' do
      ...
      expect(test_object.test).to eq default_name
      expect(test_object.name).to eq other_name
    end
  ...
  describe 'default behaviour' do
    ...
    it 'must raise normally when calling a undefined method' do
      ...
      exception = expect do
        ...
        expect(error.message).to eq 'undefined method `method_is_not_there\''
      end
    end
  end
